...
public class ChecklistDiarioEpiViewModel extends ViewModel {
    ...
    private InspecaoEPIRepository mRepository;
    ...
    public ChecklistDiarioEpiViewModel(DataToAdapterService service){
        mService = service;
    }



    public LiveData<String> updateOffline(InspecaoEPI item) {
    ...
    private void updateOfflineSingle(InspecaoEPI item) {
